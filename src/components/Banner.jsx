...
const Banner = () => {
    return (
        <div className=''>
            <div className='bg-[rgb(149,56,226)] h-[695px] text-white text-center py-32 space-y-7 mx-5 rounded-2xl'>
                ...
                <button className="bg-white px-5 py-2 rounded-full text-[rgb(149,56,226)] font-bold hover:bg-gray-200 ">Responsive</button>
            </div>
